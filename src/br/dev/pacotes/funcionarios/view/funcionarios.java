...
public class funcionarios extends javax.swing.JFrame {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        if(validarCampos(f.getNome(), f.getCpf(), f.getEndereco(), f.getArea() )){
    ...
    public boolean validarCampos(String nome, String cpf, String endereco, String area){
        if(nome.trim().isEmpty() || cpf.trim().isEmpty() || area.trim().isEmpty() || endereco.trim().isEmpty()) {
    ...
    public Funcionario gerarFuncionario(){
        ...
        String area = txt_area.getText();
         ...
         Funcionario f = new Funcionario(nome, cpf, endereco, area);
         return f;
    }
